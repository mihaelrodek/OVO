...
public class SphereParameters {
     ...
     * @param material parametri materijala kugle
     * @param n                  faktor jacine spekularne komponente
     * @param ni                 faktor refrakcije
     */
    public SphereParameters(Point centerPosition, float radius, float[] raysContributions, PropertyVector[] material, float n, float ni) {
