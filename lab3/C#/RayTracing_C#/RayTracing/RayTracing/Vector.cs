...
namespace raytracing
{
    ...
    public class Vector
    {
        ...
        {
            return normal.multiple(2 * this.dotProduct(normal)).sub(this);
        }
        ...
        public Vector getRefractedVector ( Vector normal, double nI )
        {
            ...
            double D = 4 * (b * b * cosA * cosA - b * b + 1);
            double a = (-2 * b * cosA + Math.Sqrt(D)) / 2;

            return normal.multiple(-a).add(this.multiple(-b));
        }
    }
}